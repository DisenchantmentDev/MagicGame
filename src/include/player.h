...
typedef struct {
    ...
    int shield; //Health needs to be restored with pickups but shield will restore on its own
    int armor; //Armor provides damage reduction on health damage, starts at 0 and can be raised up to 90%
} Player;
